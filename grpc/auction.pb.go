...
type BidRequest struct {
	...
	RequestID     *int64                 `protobuf:"varint,4,opt,name=requestID" json:"requestID,omitempty"`
...
func (x *BidRequest) GetRequestID() int64 {
...
func (x *UpdateQuery) GetRequestID() int64 {
	if x != nil && x.RequestID != nil {
		return *x.RequestID
	}
	return 0
...
const file_grpc_auction_proto_rawDesc = "" +
	...
	"\trequestID\x18\x04 \x01(\x03R\trequestID\"`\n" +
	...
	"\trequestID\x18\x02 \x01(\x03R\trequestID*,\n" +
	"\x04eAck\x12\r\n" +
